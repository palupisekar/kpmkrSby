...
<link href=<?php echo base_url('//fonts.googleapis.com/css?family=Proxima+Nova:400,700italic,700,400italic,300italic,300')?> rel='stylesheet' type='text/css'>
<!-- //font -->
						...
						<nav class="navbar navbar-default">
							...
							<div class="navbar-header">
								...
								<div class="agileits-logo">
									<a href="<?php echo base_url()?>"><img src=<?php echo base_url("assets/images/header.png")?> alt="KPMKR-Surabaya" style="width:250px;height:35px;"/></a>
								</div>
							</div>
							...
							<div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
								<nav>
									<ul class="nav navbar-nav">
										...
										<li class="dropdown" style="cursor: pointer;"><a href="#">Login</a>
										 	<div class="dropdown-content">
										 	<a href="<?php echo base_url().'login'?>">Login</a>
										    <a href="<?php echo base_url().'regis'?>">Registration</a>
										</li>
									</ul>
								</nav>
							</div>
							...
							<div class="slider">
								<div class="callbacks_container">
									<ul class="rslides callbacks callbacks1" id="slider4">
										...
										<!--<li>
											<div class="w3ls-text">
												<img src=<?php echo base_url("assets/images/slide/3.jpg")?> alt="" class="img-responsive" />
											</div>
										</li>
										<li>
											<div class="w3ls-text">
												<img src=<?php echo base_url("assets/images/slide/2.jpg")?> alt="" class="img-responsive" />
											</div>
										</li>
										<li>
											<div class="w3ls-text">
												<img src=<?php echo base_url("assets/images/slide/6.jpg")?> alt="" class="img-responsive" />
											</div>
										</li>
										<li>
											<div class="w3ls-text">
												<img src=<?php echo base_url("assets/images/slide/5.jpg")?> alt="" class="img-responsive" />
											</div>
										</li>-->
									</ul>
								</div>
	...
	<div class="welcome" id="about">
		<div class="container">
			...
			<div class="agileinfo-about-info"> 
                ...
                <p><button class="buttons button5"><a href="#" data-toggle="modal" data-target="#myModal" style=" text-transform: uppercase;color:black">See more details</a></button></p>
			</div>
		...
		<div class="contact-info-grids">
			<div class="container">
				...
				<div class="contact-form">
					<form method="POST" action="<?php echo base_url()."message/email";?>">
