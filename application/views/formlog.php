...
<!--[if (gt IE 9)|!(IE)]><!--> <html lang="en" class="no-js"> <!--<![endif]-->
    ...
    <body>
        <div class="container">
            ...
            <header>
                <h1><span>Login as Admin</span></h1>
				<nav class="codrops-demos">
					<span>Kerukunan Pelajar <strong>Mahasiswa </strong>Kepulauan <strong>Riau</strong></span>
				</nav>
            </header>
            <section>				
                <div id="container_demo" >
                    ...
                    <div id="wrapper">
                        <div id="login" class="animate form">
                            <form action="<?php echo base_url('logadmin/aksi_login'); ?>" method="post" autocomplete="on"> 
                                <h1>Log in</h1> 
                                <p> 
