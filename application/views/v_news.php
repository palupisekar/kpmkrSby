                ...
                <div class="row">
                            ...
                            foreach ($data as $x) 
                               foreach($x as $n){
                                ...
                                <td><?= $n['isiberita'] ?></td>
                                <td><img src="<?php echo base_url()."assets/images/news/".$n['image']; ?>" width="150"/></td>
                                <td>
                                        <?php echo anchor('crudNews/edit/'.$n["idNews"],'edit'); ?>
                                        <?php echo anchor('crudNews/hapus/'.$n["idNews"],'delete'); ?> 
                                </td>   
                                </tr>
                        <?php ;}} ?>
                        </table>
                        ...
                        ?>
                          <div>
                             <a href="<?php echo base_url('crudNews/index') ?>"><button type="button" class="btn btn-lg" style="text-align: center">Back</button></a>
                         </div>  
                        <!--END OF VIEW DATA-->
